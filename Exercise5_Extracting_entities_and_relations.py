...
#list of sentences that we will be processing
sentences = ["All living things are made of cells.",
             "Cells have organelles."]
             
#compile regular expression-like patterns 
verb_patterns = [[{"POS":"AUX"}, {"POS":"VERB"},
                  {"POS":"ADP"}],
                 [{"POS":"AUX"}]]

#contains_root function 
...
#find triplets of subjectrelation-object in the sentences
...
print("#loop through our sentence list to find its relation triplets:")
